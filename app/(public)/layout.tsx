      ...
      <nav className="border-b border-default bg-surface-100">
        <div className="flex h-14 max-w-[1280px] mx-auto items-center justify-between px-6">
          <Link href="/" className="flex items-center gap-2">
            <span className="flex h-6 w-6 items-center justify-center rounded-sm bg-brand text-xs font-bold text-foreground-contrast select-none">
              D
            </span>
            <span className="text-sm font-medium text-foreground">DCSE Alumni Association</span>
          </Link>
      ...
      <footer className="border-t border-default bg-surface-100">
        <div className="max-w-[1280px] mx-auto px-6 py-6">
          <p className="text-xs text-foreground-lighter">
            © {new Date().getFullYear()} DCSE Alumni Association · University of Engineering &amp; Technology, Peshawar
          </p>
        </div>
      </footer>
    </div>
